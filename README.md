...
초기에는 AI 분석을 별도 Python(FastAPI) 서버로 분리했습니다. AI 생태계 활용을 고려한 선택이었지만, 운영해보니 Python 서버가 단일 장애점이 되어 콜드스타트 시 첫 요청이 8~10초 지연되고 502 오류가 반복됐습니다. 두 서비스를 유지하는 비용 및 운영 부담도 컸습니다.
